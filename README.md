...
```
  1.    [
  2.      {
  3.        name: string, // title of the column 
  4.        key: string, // unique name of the column, also the key of the JSON object that wants to render in table.
  5.        type: string, // type of the columns
  6.      },
  7.    ]
  ```
`2) apiLink: string`
